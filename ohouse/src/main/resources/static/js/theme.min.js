...
!function () {
    ...
    null != (r = document.querySelector(".navbar-sticky")) && (r.classList, t = r.offsetHeight, window.addEventListener("scroll", function (e) {
        ...
        for (var e = document.querySelectorAll(".file-drop-area"), t = 0; t < e.length; t++) !function () {
            var n = e[t].querySelector(".file-drop-input"), o = e[t].querySelector(".file-drop-message"),
        ...
        if (e.length) for (var t = 0; t < e.length; t++) {
            var r = !!e[t].dataset.thumbnails, n = !!e[t].dataset.video, o = [lgZoom, lgFullscreen],
                n = n ? [lgVideo] : [], r = r ? [lgThumbnail] : [], r = [].concat(o, n, r);
            lightGallery(e[t], {
        ...
        if (i.length) for (var e = 0; e < i.length; e++) !function (r) {
        ...
        if (null != e) for (var u = 0; u < e.length; u++) {
            var t = function () {
                var t, r, n, o, a = e[u].dataset.countdown, l = e[u].querySelector(".countdown-days .countdown-value"),
                    i = e[u].querySelector(".countdown-hours .countdown-value"),
                    c = e[u].querySelector(".countdown-minutes .countdown-value"),
                    s = e[u].querySelector(".countdown-seconds .countdown-value"), a = new Date(a).getTime();
                if (isNaN(a)) return {v: void 0};
                setInterval(function () {
                    var e = (new Date).getTime(), e = parseInt((a - e) / 1e3);
        ...
        if (null !== e) {
            for (var l = 0; l < e.length; l++) !function () {
                var t = e[l].querySelector('button[type="submit"]'), r = t.innerHTML,
                    n = e[l].querySelector(".form-control"), o = e[l].querySelector(".subscription-form-antispam"),
            ...
            var i = function (e, t, r, n, o) {
                t.innerHTML = "Sending...";
                var a = e.action.replace("/post?", "/post-json?"), e = "&" + r.name + "=" + encodeURIComponent(r.value),
        ...
        for (var a = document.querySelectorAll(".range-slider"), l = 0; l < a.length; l++) !function () {
            var e = a[l].querySelector(".range-slider-ui"), r = a[l].querySelector(".range-slider-value-min"),
                n = a[l].querySelector(".range-slider-value-max"), t = {
